...
class Sprites:
    def __init__(self):
        self.sprite_parameters = {
            'sprite_devil': {
                'sprite': [pygame.image.load(f'sprites/devil/base/0.png').convert_alpha() for i in range(8)],
                'viewing_angles': True,
                'shift': -0.2,
                'scale': 1.1,
                'animation': deque(
                    [pygame.image.load(f'sprites/devil/anim/0.png').convert_alpha() for i in range(9)]),
                'animation_dist': 150,
                'animation_speed': 10,
                'blocked': True,
            },
